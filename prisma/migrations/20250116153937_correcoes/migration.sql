/*
  ...
  - You are about to drop the `ProdutosNovos` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE `ProdutosNovos` DROP FOREIGN KEY `ProdutosNovos_compraId_fkey`;
